...
const HeroInnerPages = ({ children, className, pageTitle }) => {
    return (
        ...
        <div className={`${className} bg-[url(https://i.ibb.co/3fNMsff/inner-pages-hero.webp)] relative w-full h-[500px] bg-cover primaryHeading text-white flex justify-start items-center text-start`}>
            <div className="md:max-w-screen-md lg:max-w-screen-2xl mx-auto flex flex-col gap-10 justify-start w-full after:h-full after:content-[''] after:absolute after:w-full after:top-0 after:left-0 after:bg-gradient-to-r after:from-[#09161d] after:to-[#09161d46]">
